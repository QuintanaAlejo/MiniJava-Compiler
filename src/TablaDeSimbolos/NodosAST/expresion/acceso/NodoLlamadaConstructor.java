...
public class NodoLlamadaConstructor extends NodoAcceso {
    ...
    public void generar(){
        ...
        Main.TS.getInstructionList().add("PUSH " + Main.TS.getClase(token.getLexeme()).getVTable() + " ; Cargo la vtable de la clase");
        ...
        Main.TS.getInstructionList().add("PUSH CONSTRUCTOR_" + token.getLexeme() + " ; Direccion del constructor");
        Main.TS.getInstructionList().add("CALL ");
